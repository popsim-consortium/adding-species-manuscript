...
baselines for further analyses: simulations incorporating
...
have enabled researchers to ask even more
...
\item
  ...
  since mutation rates and evolutionary processes are known to vary along the genome and through time \citep{Benzer1961,Ellegren2003,Supek2019}.
...
\item
  ...
  should translate in simulation to the average observed genetic diversity in that species. Note, however, that this average effective population size will not capture features of genetic variation that are caused by recent changes in population size and the presence of population structure \citep{MacLeod2013,Eldon2015}.
...
As mentioned above, it is a widely appreciated the fact that linked selection modulates
...
it is desireable to choose parameters that best reflect our current understanding of evolution.
...
% Izabel: this bit above is a repetition, maybe delete or shrink? Or maybe when talking about it in the chromosome part just briefly mention it. 
