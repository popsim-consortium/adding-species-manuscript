...
%REVISION: TBD - add more details and citations to this sentence
...
Since this mechanism is fundamentally different from crossover recombination, such species cannot be realistically simulated with a recombination model that considers only crossovers,
...
Several studies have compare different approaches to demography inference \citep[e.g.,][]{Harris2013,Beichman2017}, but unfortunately, there is currently no succinct handbook that describes the relative strengths and weaknesses of different methods.
