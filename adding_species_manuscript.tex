...
First, the organization of genes on chromosomes is a key feature of a species' genome that is ignored in many traditional population genomic simulations
 (see \cite{schrider2020background} one exception).
...
Note that unless this option is explicitly turned on in simulation, the effective fraction of gene conversions is 0, even if a positive fraction is specified for that species.


Another important extension of \stdpopsim allows augmenting a genome assembly with genome annotations, such as coding regions, promoters, conserved elements, etc.
