...
\author[10]{Ahmed Hasan}
% \author[]{Xin Huang}
% \author[]{Leonardo Iasi}
\author[11]{Jana Obšteter}
% \author[]{Vitor Antonio Corrêa Pavinato}
\author[12,13]{David Peede}
% \author[]{Ekaterina Noskova}
% \author[]{Alice Pearson}
% \author[]{Manolo Perez}
\author[6]{Chris Smith}
\author[14]{Jeff Spence}
% \author[2]{Anastasia Teterina}
\author[15]{Per Unneberg}
% \author[]{Juan Manuel Vasquez}
\author[16]{Ryan Waples}
\author[17]{Anthony Wilder Wohns}
\author[18]{Yan Wong}
\author[19]{Reed Cartwright}
\author[20]{Aaron Ragsdale}
\author[21]{Franz Baumdicker}
\author[22]{Gregor Gorjanc}
\author[23]{Ryan Gutenkunst}
\author[18]{Jerome Kelleher}
\author[6]{Andy Kern}
\author[6,24]{Peter Ralph}
\author[25]{Dan Schrider}
\author[26]{Ilan Gronau}
...
\affil[10]{\small{Computational \& Evolutionary Genomics - Department of Cell and Systems Biology, University of Toronto Mississauga}}
\affil[11]{\small{Agricultural Institute of Slovenia, Department of Animal Science, Hacquetova ulica 17, Ljubljana, Slovenia}}
\affil[12]{\small{Department of Ecology and Evolutionary Biology, Brown University, Providence, RI, USA}}
\affil[13]{\small{Center for Computational Molecular Biology, Brown University, Providence, RI, USA}}
\affil[14]{\small{Department of Genetics, Stanford University School of Medicine, Stanford, CA, 94305}}
\affil[15]{\small{Department of Cell and Molecular Biology, National Bioinformatics Infrastructure Sweden, Science for Life Laboratory, Uppsala University,  Husargatan 3, SE-752 37 Uppsala, Sweden}}
\affil[16]{\small{Department of Biostatistics University of Washington}}
\affil[17]{\small{Broad Institute of MIT and Harvard, Cambridge, MA 02142, USA}}
\affil[18]{\small{Big Data Institute, Li Ka Shing Centre for Health Information and Discovery, University of Oxford, OX3 7LF, UK}}
\affil[19]{\small{Genomics, Evolution, and Bioinformatics, School of Life Sciences and The Biodesign Institute, Arizona State University, Tempe, Arizona}}
\affil[20]{\small{Integrative Biology, University of Wisconsin-Madison, Madison, Wisconsin}}
\affil[21]{\small{Cluster of Excellence - Controlling Microbes to Fight Infections, Eberhard Karls Universität Tübingen, Tübingen, Baden-Württemberg, Germany}}
\affil[22]{\small{The Roslin Institute and Royal (Dick) School of Veterinary Studies, University of Edinburgh, Edinburgh EH25 9RG, UK}}
\affil[23]{\small{Molcular and Cellular Biology, University of Arizona, Tucson, Arizona 85721}}
\affil[24]{\small{Department of Mathematics, University of Oregon, Eugene OR 97402}}
\affil[25]{\small{School of Medicine - Genetics, University of North Carolina at Chapel Hill}}
\affil[26]{\small{Efi Arazi School of Computer Science, Reichman University, Herzliya, Israel}}
