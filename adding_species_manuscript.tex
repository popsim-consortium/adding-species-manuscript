...
and the sophistication of simulation software,
...
affiliated project networks~\citep[e.g.][]{Cheng2018,Rhie2021,darwin2022sequence}
are
...
% JK: this original text seems unnecessarily negative - were old-school coalescent
% simulations not useful?
...
% relevant to generating those patterns.
Increasing amounts of data have enabled researchers to ask ever more
specific and precise questions, and consequently, simulations must incorporate
...
developing simulations of a particular species.
...
% JK: can't really see what this paragraph was saying that was different
...
\item
  ...
  but we expect this number to dramatically increase in the near future due to genome
  initiatives such as the Earth Biogenome \citep{Lewin2022}.
  ...
  typically do not good estimates of recombination rate or genetic maps,
