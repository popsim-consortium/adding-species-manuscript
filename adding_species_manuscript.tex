...
%Ilan: moved this up here, to leave the end of the abstract to the bigger ideas
...
Expansion of the species catalog involved community-driven efforts to increase coverage more broadly across the tree of life
to 21 species, with 25 demographic models and 37 genetic maps.
Our experience throughout this process was that people are indeed keen to put in the time and effort to include their study species,
...
%Ilan: removed mention of inference methods, which is not the only objective (and not necessarily even the main objective) of the popsim community
...
% Ilan: I think this brief summary is a bit redundant. Better to jump right into the "results"
...
One way to deal with this situation is to treat the longer contigs or scaffolds in these builds as separate chromosomes in the simulation.
%
...
When lumping short contigs together, one should weigh the benefits of
fitting the amount of data of real genomes and capturing the linkage structure within each contig,
against the adverse effects of inducing false or inaccurate correlation between variants from different contigs.
%
...
such as reproducing the main statistical properties of background selection.
%
...
%, with some prior knowledge of mutation and recombination rates,
