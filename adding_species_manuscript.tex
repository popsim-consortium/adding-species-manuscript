...
\pagestyle{fancy}
\fancyhead[R]{\textbf{stdpopsim recipe: how to add a species}}
% for figures
\usepackage{graphicx}
...
is, as they incorporate more elements of the species' biology. Important
...
\item
  ...
  unrealistic patterns of genetic variation (eg. \citep{Navascues2009}). At a
...
\item
  ...
  population genetics simulator SLiM \citep{Haller2019}. This,
...
Currently there are multiple gaps in the species catalog (Figure \ref{fig:tree}), and having a greater
...
\item
  ...
  genetic parameters as detailed in (TODO: finalize section numbers/titles) Section XXXX: Making a population
  genomic simulation.''
\item
...
from\citep{Pombi2006}. In that manuscript
