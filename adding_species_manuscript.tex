...
who wisth to develop simulations of their own species of interest
...
\hypertarget{sec2}{%
	\section*{The utility of \stdpopsim for genome-wide simulations}\label{sec:std-sim}
}
...
\stdpopsim is build on tp of the
\texttt{msprime} \citep{Kelleher2016,Nelson2020} and \texttt{SLiM} \citep{Haller2019} simulation engines,
...
%% PLR: this makes an interesting point at the end, but I think it's one for the discussion, not here?
