...
=======
Simulation is one of the key tools in population genomics, and
is useful for both methods development and empirical research, including
providing training data and null models for hypothesis testing.
...
of species becomes more acute. Population genomic data is being generated
...
(10KP), among many others, that will facilitate an avalanche of population genomic
...
of some species, the broader population genomics community would benefit from additional guidance in putting together such simulations.
...
Simulation is one of the key tools in population genomics, but can be unexpectedly challenging and has many hidden pitfalls for the unwary population geneticist. 
...
Purposes of generating population genomic simulations include
...
So when choosing to generate realistic population genomic simulations for a species of interest, certain population and species genetic parameters should be known.
To run a population genomic simulation with the current standard of realism, 
...
=======
However, the goal of much population genomics work 
